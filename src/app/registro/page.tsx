...
/**
 * Renders the account registration page using email and password.
      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-sm border border-white/10 rounded-3xl p-8 shadow-2xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-[#F8FAFC]/70">Correo + contraseña + wallet Hedera Testnet</p>
          </div>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          >
            {isSubmitting ? "Creando cuenta..." : "Crear cuenta y wallet"}
          </button>
        </form>
